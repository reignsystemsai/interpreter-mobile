...
const styles = StyleSheet.create({
  ...
  glassButton: { alignItems: 'center', backgroundColor: 'rgba(3,15,35,0.58)', borderColor: 'rgba(45,156,255,0.66)', borderRadius: 20, borderWidth: 1, minWidth: 72, paddingHorizontal: 12, paddingVertical: 10, shadowColor: '#19D7FF', shadowOpacity: 0.28, shadowRadius: 9 },
  ...
  shutterOuter: { alignItems: 'center', borderColor: '#19D7FF', borderRadius: 39, borderWidth: 3, height: 78, justifyContent: 'center', shadowColor: '#19D7FF', shadowOpacity: 0.75, shadowRadius: 14, width: 78 },
  shutterInner: { backgroundColor: WHITE, borderColor: '#0878FF', borderRadius: 31, borderWidth: 2, height: 62, width: 62 },
  flip: { alignItems: 'center', backgroundColor: 'rgba(7,35,79,0.76)', borderColor: 'rgba(45,156,255,0.66)', borderRadius: 29, borderWidth: 1, height: 58, justifyContent: 'center', shadowColor: '#19D7FF', shadowOpacity: 0.28, shadowRadius: 9, width: 58 },
