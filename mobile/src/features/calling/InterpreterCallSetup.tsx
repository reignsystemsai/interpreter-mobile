...
const styles = StyleSheet.create({
  page: { backgroundColor: '#03060D', flex: 1, paddingTop: 4 },
  back: { color: '#75A9FF', fontSize: 16, fontWeight: '700', paddingVertical: 8 },
  eyebrow: { color: '#75A9FF', fontSize: 12, fontWeight: '800', letterSpacing: 2.4, marginTop: 18 },
  title: { color: WHITE, fontSize: 30, fontWeight: '800', letterSpacing: -0.8, lineHeight: 36, marginTop: 7 },
  label: { color: '#8FA8CE', fontSize: 12, fontWeight: '800', letterSpacing: 1.1, marginBottom: 8, marginTop: 24, textTransform: 'uppercase' },
  segment: { backgroundColor: '#0A1220', borderColor: '#172A4A', borderRadius: 19, borderWidth: 1, flexDirection: 'row', gap: 6, padding: 5 },
  ...
  choiceText: { color: '#8FA8CE', fontSize: 14, fontWeight: '700' },
  choiceTextActive: { color: WHITE },
  languageRow: { alignItems: 'center', backgroundColor: '#0A1220', borderColor: '#172A4A', borderRadius: 17, borderWidth: 1, flexDirection: 'row', justifyContent: 'space-between', marginBottom: 9, minHeight: 58, paddingHorizontal: 16 },
  languageCaption: { color: '#8FA8CE', fontSize: 12, fontWeight: '600' },
  languageValue: { color: WHITE, fontSize: 15, fontWeight: '700' },
  ...
  sheet: { backgroundColor: '#07101F', borderColor: '#17366C', borderTopLeftRadius: 28, borderTopRightRadius: 28, borderWidth: 1, maxHeight: '68%', padding: 22 },
  sheetTitle: { color: WHITE, fontSize: 23, fontWeight: '800', marginBottom: 10 },
