...
export function ContactsPermissionPanel({ autoRequest = false, onBack }: { autoRequest?: boolean; onBack: () => void }) {
  ...
  return (
    <View style={styles.listScreen}>
      <View style={styles.titleRow}><Text style={styles.title}>Contacts</Text><Pressable accessibilityLabel="Reload device contacts" onPress={() => void refresh()} style={styles.reloadButton}><Text style={styles.reloadText}>Reload</Text></Pressable></View>
...
const styles = StyleSheet.create({
  listScreen: { minHeight: 560 }, back: { alignSelf: 'flex-start', marginBottom: 10, paddingVertical: 5 }, backText: { color: '#2D9CFF', fontSize: 16, fontWeight: '600' }, title: { color: '#F8FBFF', fontSize: 27, fontWeight: '800' }, body: { color: '#8BA6C9', fontSize: 15, lineHeight: 22, marginTop: 10 },
  statusCard: { backgroundColor: 'rgba(7,23,51,0.72)', borderColor: 'rgba(62,157,255,0.28)', borderRadius: 18, borderWidth: 1, marginTop: 20, padding: 16 }, statusLabel: { color: '#8BA6C9', fontSize: 13 }, statusValue: { color: '#F8FBFF', fontSize: 17, fontWeight: '700', marginTop: 4 }, error: { color: '#FF6B7C', fontSize: 13, marginTop: 10 },
  primary: { alignItems: 'center', backgroundColor: '#075BFF', borderColor: '#19D7FF', borderRadius: 18, borderWidth: 1, marginTop: 16, paddingVertical: 15, shadowColor: '#19D7FF', shadowOpacity: 0.35, shadowRadius: 12 }, primaryText: { color: '#FFFFFF', fontSize: 16, fontWeight: '700' }, secondary: { alignItems: 'center', backgroundColor: 'rgba(7,23,51,0.72)', borderColor: 'rgba(62,157,255,0.28)', borderRadius: 18, borderWidth: 1, marginTop: 10, paddingVertical: 14 }, secondaryText: { color: '#72B8FF', fontSize: 15, fontWeight: '600' }, disabled: { opacity: 0.5 },
  titleRow: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, reloadButton: { backgroundColor: 'rgba(7,23,51,0.76)', borderRadius: 15, paddingHorizontal: 15, paddingVertical: 9 }, reloadText: { color: '#4EAFFF', fontWeight: '700' }, search: { backgroundColor: 'rgba(7,23,51,0.76)', borderColor: 'rgba(62,157,255,0.28)', borderRadius: 16, borderWidth: 1, color: '#F8FBFF', fontSize: 15, marginTop: 15, paddingHorizontal: 15, paddingVertical: 12 },
  contactList: { paddingBottom: 28, paddingTop: 8 }, contactRow: { alignItems: 'center', borderBottomColor: 'rgba(62,157,255,0.14)', borderBottomWidth: 1, flexDirection: 'row', minHeight: 68 }, avatar: { alignItems: 'center', backgroundColor: '#071B3D', borderColor: '#187DFF', borderRadius: 20, borderWidth: 1, height: 40, justifyContent: 'center', width: 40 }, avatarText: { color: '#4EAFFF', fontSize: 17, fontWeight: '800' }, contactCopy: { flex: 1, marginLeft: 11 }, contactName: { color: '#F8FBFF', fontSize: 16, fontWeight: '700' }, contactMeta: { color: '#7794BA', fontSize: 11, marginTop: 3 }, chevron: { color: '#2D9CFF', fontSize: 28 }, empty: { color: '#7794BA', fontSize: 14, lineHeight: 21, paddingHorizontal: 15, paddingVertical: 28, textAlign: 'center' }, pressed: { opacity: 0.62 },
  details: { paddingBottom: 34 }, detailAvatar: { alignItems: 'center', alignSelf: 'center', backgroundColor: '#071B3D', borderColor: '#19D7FF', borderRadius: 40, borderWidth: 1, height: 80, justifyContent: 'center', shadowColor: '#19D7FF', shadowOpacity: 0.32, shadowRadius: 12, width: 80 }, detailAvatarText: { color: '#4EAFFF', fontSize: 34, fontWeight: '800' }, detailName: { color: '#F8FBFF', fontSize: 25, fontWeight: '800', marginTop: 9, textAlign: 'center' }, userStatus: { color: '#4ED8A2', fontSize: 13, marginTop: 4, textAlign: 'center' }, callGrid: { gap: 10, marginTop: 17 }, callButton: { alignItems: 'center', backgroundColor: 'rgba(7,23,51,0.72)', borderColor: 'rgba(62,157,255,0.32)', borderRadius: 18, borderWidth: 1, flexDirection: 'row', minHeight: 58, paddingHorizontal: 20, shadowColor: BLUE, shadowOpacity: 0.14, shadowRadius: 8 }, callLabel: { color: '#A9D3FF', fontSize: 14, fontWeight: '600', marginLeft: 16 }, interpretButton: { backgroundColor: 'rgba(7,23,51,0.72)' }, interpretLabel: { color: '#A9D3FF' }, interpretIcon: { alignItems: 'center', borderColor: '#19D7FF', borderRadius: 13, borderWidth: 1.5, height: 26, justifyContent: 'center', width: 26 }, interpretIconText: { color: '#4EAFFF', fontSize: 15, fontWeight: '800' }, comingSoon: { color: '#7794BA', fontSize: 9, marginTop: 2 }, sectionTitle: { color: '#A9D3FF', fontSize: 15, fontWeight: '800', marginBottom: 7, marginTop: 20 }, detailCard: { backgroundColor: 'rgba(7,23,51,0.66)', borderColor: 'rgba(62,157,255,0.24)', borderRadius: 18, borderWidth: 1, paddingHorizontal: 15 }, detailRow: { paddingVertical: 11 }, fieldLabel: { color: '#7794BA', fontSize: 11, fontWeight: '700' }, detailValue: { color: '#F8FBFF', fontSize: 15, lineHeight: 21, marginTop: 3 }, input: { backgroundColor: '#07162F', borderColor: '#1D6FC5', borderRadius: 15, borderWidth: 1, color: '#F8FBFF', fontSize: 15, marginTop: 9, paddingHorizontal: 14, paddingVertical: 12 },
