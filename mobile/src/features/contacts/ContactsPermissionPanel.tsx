...
const styles = StyleSheet.create({
  listScreen: { minHeight: 560 }, back: { alignSelf: 'flex-start', marginBottom: 10, paddingVertical: 5 }, backText: { color: '#75A9FF', fontSize: 16, fontWeight: '600' }, title: { color: '#FFFFFF', fontSize: 27, fontWeight: '800' }, body: { color: '#8FA8CE', fontSize: 15, lineHeight: 22, marginTop: 10 },
  ...
  titleRow: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, reloadButton: { backgroundColor: '#0B1830', borderRadius: 15, paddingHorizontal: 15, paddingVertical: 9 }, reloadText: { color: '#75A9FF', fontWeight: '700' }, search: { backgroundColor: '#0A1220', borderColor: '#17366C', borderRadius: 16, borderWidth: 1, color: '#FFFFFF', fontSize: 15, marginTop: 15, paddingHorizontal: 15, paddingVertical: 12 },
  contactList: { paddingBottom: 28, paddingTop: 8 }, contactRow: { alignItems: 'center', flexDirection: 'row', minHeight: 68 }, avatar: { alignItems: 'center', backgroundColor: '#0B1830', borderRadius: 20, height: 40, justifyContent: 'center', width: 40 }, avatarText: { color: '#75A9FF', fontSize: 17, fontWeight: '800' }, contactCopy: { flex: 1, marginLeft: 11 }, contactName: { color: '#FFFFFF', fontSize: 16, fontWeight: '700' }, contactMeta: { color: '#8FA8CE', fontSize: 11, marginTop: 3 }, chevron: { color: BLUE, fontSize: 28 }, empty: { color: '#8FA8CE', fontSize: 14, lineHeight: 21, paddingHorizontal: 15, paddingVertical: 28, textAlign: 'center' }, pressed: { opacity: 0.62 },
  details: { paddingBottom: 34 }, detailAvatar: { alignItems: 'center', alignSelf: 'center', backgroundColor: '#0B1830', borderColor: '#17498F', borderRadius: 40, borderWidth: 1, height: 80, justifyContent: 'center', width: 80 }, detailAvatarText: { color: '#75A9FF', fontSize: 34, fontWeight: '800' }, detailName: { color: '#FFFFFF', fontSize: 25, fontWeight: '800', marginTop: 9, textAlign: 'center' }, userStatus: { color: '#8FA8CE', fontSize: 13, marginTop: 4, textAlign: 'center' }, callGrid: { flexDirection: 'row', gap: 10, marginTop: 17 }, callButton: { alignItems: 'center', backgroundColor: '#0A1220', borderColor: '#17366C', borderRadius: 18, borderWidth: 1, flex: 1, minHeight: 88, justifyContent: 'center', padding: 8 }, callLabel: { color: '#D9E7FF', fontSize: 12, fontWeight: '600', marginTop: 6, textAlign: 'center' }, interpretButton: { backgroundColor: BLUE }, interpretLabel: { color: '#FFFFFF' }, interpretIcon: { alignItems: 'center', borderColor: '#FFFFFF', borderRadius: 13, borderWidth: 1.5, height: 26, justifyContent: 'center', width: 26 }, interpretIconText: { color: '#FFFFFF', fontSize: 15, fontWeight: '800' }, comingSoon: { color: '#8FA8CE', fontSize: 9, marginTop: 2 }, sectionTitle: { color: '#D9E7FF', fontSize: 15, fontWeight: '800', marginBottom: 7, marginTop: 20 }, detailCard: { backgroundColor: '#0A1220', borderColor: '#17366C', borderRadius: 18, borderWidth: 1, paddingHorizontal: 15 }, detailRow: { paddingVertical: 11 }, fieldLabel: { color: '#8FA8CE', fontSize: 11, fontWeight: '700' }, detailValue: { color: '#FFFFFF', fontSize: 15, lineHeight: 21, marginTop: 3 }, input: { backgroundColor: '#FFFFFF', borderColor: '#DDE5F1', borderRadius: 15, borderWidth: 1, color: '#101828', fontSize: 15, marginTop: 9, paddingHorizontal: 14, paddingVertical: 12 },
