...
const styles = StyleSheet.create({
  destinationBackdrop: { backgroundColor: 'rgba(0,4,12,0.62)', flex: 1, justifyContent: 'flex-end', paddingHorizontal: 10, paddingTop: 40 },
  page: { backgroundColor: 'rgba(4,16,38,0.92)', borderColor: 'rgba(45,156,255,0.48)', borderTopLeftRadius: 30, borderTopRightRadius: 30, borderWidth: 1, maxHeight: '91%', overflow: 'hidden', shadowColor: '#19D7FF', shadowOffset: { height: 0, width: 0 }, shadowOpacity: 0.20, shadowRadius: 24 },
  header: { alignItems: 'center', borderBottomColor: 'rgba(62,157,255,0.22)', borderBottomWidth: 1, flexDirection: 'row', paddingHorizontal: 14, paddingTop: 6 },
  ...
  title: { color: '#F8FBFF', flex: 1, fontSize: 21, fontWeight: '700', textAlign: 'center' },
  headerSpacer: { width: 50 },
  content: { padding: 22, paddingBottom: 48 },
  intro: { color: '#8BA6C9', fontSize: 15, lineHeight: 23, marginBottom: 18 },
  card: { backgroundColor: 'rgba(7,23,51,0.72)', borderColor: 'rgba(62,157,255,0.28)', borderRadius: 18, borderWidth: 1, marginBottom: 14, padding: 17, shadowColor: '#19D7FF', shadowOffset: { height: 0, width: 0 }, shadowOpacity: 0.10, shadowRadius: 10 },
  cardTitle: { color: '#F8FBFF', fontSize: 16, fontWeight: '700' },
  cardBody: { color: '#8BA6C9', fontSize: 14, lineHeight: 21, marginTop: 7 },
  planHeader: { alignItems: 'center', flexDirection: 'row' },
  planName: { color: '#F8FBFF', flex: 1, fontSize: 19, fontWeight: '800' },
  planPrice: { color: BLUE, fontSize: 16, fontWeight: '700' },
  allowance: { color: '#A9D3FF', fontSize: 14, fontWeight: '600', marginBottom: 10, marginTop: 8 },
  feature: { color: '#8BA6C9', fontSize: 13, lineHeight: 21 },
  input: { backgroundColor: '#07162F', borderColor: '#1D6FC5', borderRadius: 13, borderWidth: 1, color: '#F8FBFF', fontSize: 16, marginBottom: 12, minHeight: 52, paddingHorizontal: 14 },
  acceptRow: { alignItems: 'center', flexDirection: 'row', marginVertical: 8 },
  checkbox: { color: BLUE, fontSize: 24, marginRight: 9 },
  acceptText: { color: '#8BA6C9', flex: 1, fontSize: 13, lineHeight: 19 },
  ...
  value: { color: '#F8FBFF', fontSize: 17, marginTop: 6 },
  ...
  settingRow: { alignItems: 'center', borderBottomColor: 'rgba(62,157,255,0.2)', borderBottomWidth: 1, flexDirection: 'row', minHeight: 62 },
  settingLabel: { color: '#F8FBFF', flex: 1, fontSize: 16 },
  notice: { backgroundColor: '#071B3D', borderColor: 'rgba(62,157,255,0.26)', borderRadius: 16, borderWidth: 1, marginTop: 16, padding: 16 },
  noticeTitle: { color: '#72B8FF', fontSize: 15, fontWeight: '700' },
  noticeBody: { color: '#8BA6C9', fontSize: 13, lineHeight: 20, marginTop: 5 },
