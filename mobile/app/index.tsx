...
const styles = StyleSheet.create({
  ...
  safeArea: { flex: 1 },
  content: { flexGrow: 1, paddingBottom: UI_CONTROLS.layout.screen.paddingBottom, paddingHorizontal: UI_CONTROLS.layout.screen.paddingHorizontal, paddingTop: UI_CONTROLS.layout.screen.paddingTop },
  contentCompact: { paddingBottom: UI_CONTROLS.layout.screen.paddingBottomCompact, paddingHorizontal: UI_CONTROLS.layout.screen.paddingHorizontalCompact },
  menuButton: { alignItems: 'center', height: UI_CONTROLS.layout.header.buttonSize, justifyContent: 'center', position: 'absolute', right: UI_CONTROLS.layout.header.insetHorizontal, top: UI_CONTROLS.layout.header.insetTop, width: UI_CONTROLS.layout.header.buttonSize, zIndex: 2 },
  phoneButton: { alignItems: 'center', height: UI_CONTROLS.layout.header.buttonSize, justifyContent: 'center', left: UI_CONTROLS.layout.header.insetHorizontal, position: 'absolute', top: UI_CONTROLS.layout.header.insetTop, width: UI_CONTROLS.layout.header.buttonSize, zIndex: 2 },
  pressed: { opacity: 0.68, transform: [{ scale: 0.985 }] },
  disabled: { opacity: 0.56 },
  hero: { alignItems: 'center', marginTop: UI_CONTROLS.layout.hero.marginTop },
  heroCompact: { marginTop: UI_CONTROLS.layout.hero.marginTopCompact },
  logo: { height: UI_CONTROLS.layout.hero.logoSize, width: UI_CONTROLS.layout.hero.logoSize },
  logoCompact: { height: UI_CONTROLS.layout.hero.logoSizeCompact, width: UI_CONTROLS.layout.hero.logoSizeCompact },
  ...
  orbWrap: { alignItems: 'center', alignSelf: 'center', height: UI_CONTROLS.layout.listeningOrb.stageSize, justifyContent: 'center', marginTop: UI_CONTROLS.layout.listeningOrb.marginTop, width: UI_CONTROLS.layout.listeningOrb.stageSize },
  orbWrapCompact: { height: UI_CONTROLS.layout.listeningOrb.stageSizeCompact, marginTop: UI_CONTROLS.layout.listeningOrb.marginTopCompact, width: UI_CONTROLS.layout.listeningOrb.stageSizeCompact },
  orbGlow: { backgroundColor: '#F8FAFF', borderRadius: UI_CONTROLS.layout.listeningOrb.stageSize / 2, height: UI_CONTROLS.layout.listeningOrb.stageSize, position: 'absolute', shadowColor: BLUE, shadowOpacity: 0.16, shadowRadius: 24, width: UI_CONTROLS.layout.listeningOrb.stageSize },
  orbGlowCompact: { borderRadius: UI_CONTROLS.layout.listeningOrb.stageSizeCompact / 2, height: UI_CONTROLS.layout.listeningOrb.stageSizeCompact, width: UI_CONTROLS.layout.listeningOrb.stageSizeCompact },
  orb: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: '#EEF4FF', borderRadius: UI_CONTROLS.layout.listeningOrb.orbSize / 2, borderWidth: 8, height: UI_CONTROLS.layout.listeningOrb.orbSize, justifyContent: 'center', width: UI_CONTROLS.layout.listeningOrb.orbSize },
  orbCompact: { borderRadius: UI_CONTROLS.layout.listeningOrb.orbSizeCompact / 2, borderWidth: 7, height: UI_CONTROLS.layout.listeningOrb.orbSizeCompact, width: UI_CONTROLS.layout.listeningOrb.orbSizeCompact },
  dottedRing: { alignItems: 'center', borderColor: BLUE, borderRadius: UI_CONTROLS.layout.listeningOrb.ringSize / 2, borderStyle: 'dotted', borderWidth: 2.4, height: UI_CONTROLS.layout.listeningOrb.ringSize, justifyContent: 'center', width: UI_CONTROLS.layout.listeningOrb.ringSize },
  dottedRingCompact: { borderRadius: UI_CONTROLS.layout.listeningOrb.ringSizeCompact / 2, height: UI_CONTROLS.layout.listeningOrb.ringSizeCompact, width: UI_CONTROLS.layout.listeningOrb.ringSizeCompact },
  statusText: { color: '#101828', fontSize: 14, marginTop: 4, textAlign: 'center' },
  rows: { alignSelf: 'center', gap: UI_CONTROLS.layout.languageSetup.sectionGap, marginTop: UI_CONTROLS.layout.languageSetup.marginTop, maxWidth: UI_CONTROLS.layout.languageSetup.maxWidth, width: '100%' },
  rowsCompact: { gap: UI_CONTROLS.layout.languageSetup.sectionGapCompact, marginTop: UI_CONTROLS.layout.languageSetup.marginTopCompact },
  directionRow: { alignItems: 'flex-end', flexDirection: 'row', gap: UI_CONTROLS.layout.languageSetup.rowGap },
  directionRowCompact: { gap: UI_CONTROLS.layout.languageSetup.rowGapCompact },
  directionControl: { flex: 1, minWidth: 0 },
  directionLabel: { color: '#5E6B84', fontSize: 10, marginBottom: 5, marginLeft: 4 },
  languageButton: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: '#E2E8F2', borderRadius: 14, borderWidth: 1, flexDirection: 'row', height: UI_CONTROLS.layout.languageSetup.fieldHeight, paddingHorizontal: 9, shadowColor: '#0B2559', shadowOffset: { height: 3, width: 0 }, shadowOpacity: 0.07, shadowRadius: 8 },
  languageButtonText: { color: '#101828', flex: 1, fontSize: 13, marginHorizontal: 6 },
  arrowWrap: { alignItems: 'center', height: UI_CONTROLS.layout.languageSetup.fieldHeight, justifyContent: 'center', width: 32 },
  startButton: { alignSelf: 'center', borderRadius: 32, marginTop: 'auto', maxWidth: UI_CONTROLS.layout.primaryAction.maxWidth, overflow: 'hidden', shadowColor: BLUE, shadowOffset: { height: 8, width: 0 }, shadowOpacity: 0.22, shadowRadius: 16, width: UI_CONTROLS.layout.primaryAction.widthPercent },
  startGradient: { alignItems: 'center', flexDirection: 'row', height: UI_CONTROLS.layout.primaryAction.height, justifyContent: 'center' },
